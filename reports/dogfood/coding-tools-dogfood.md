...
- Workspace: `/tmp/coding-tools-mcp-dogfood-fscf9bgz/workspace`
...
- Completion rate: `1.0`
- Total elapsed: `1029.505 ms`
- Tool calls: `18`
- Argument bytes: `1710`
- Result bytes: `31354`
- First patch success: `True`
- First patch success rate: `1.0` across `3` attempts
- All case assertions passed: `True`
- Session poll calls: `0`
- Tool latency p50/p95: `14.853 / 104.949 ms`
...
### js_bugfix: PASS
- PASS search_text finds add: tiny-js-project/src/math.js:1:1: function add(a, b) {\n{"active_project": {"authority_files": [], "id": "0:.", "name": "workspace", "path": "/tmp/coding-tools-mcp-dogfood-fscf9b...
...
- PASS exec_command npm test passes: Status: success | command_success=true | exit code 0 | 182 ms\njs ok\n\nstderr:\nnpm notice run test\nnpm notice run node test/math.test.js\n\n{"active_project": {"authority_fil...
...
- PASS read_file returns python source: def add(a, b):\n    return a + b\n\n{"active_project": {"authority_files": [], "id": "0:.", "name": "workspace", "path": "/tmp/coding-tools-mcp-dogfood-fscf9bgz/workspace", "rel...
...
- PASS exec_command unittest passes: Status: success | command_success=true | exit code 0 | 81 ms\nstderr:\n..\n----------------------------------------------------------------------\nRan 2 tests in 0.000s\n\nOK\n\...
...
- PASS exec_command returns session_id: Status: running | 42 ms\nready\n\nSession still running; continue with write_stdin(session_id="job_mBSmgZPHJVjHEgwPL2R0Wo7OJc0EUkI5", chars="", yield_time_ms=10000, context_id=...
- PASS write_stdin accepts hello: Status: running\nhello\necho:hello\n\nSession still running; continue with write_stdin(session_id="job_mBSmgZPHJVjHEgwPL2R0Wo7OJc0EUkI5", chars="", yield_time_ms=10000, contex...
...
- PASS kill_session terminates or reports already closed: Session job_mBSmgZPHJVjHEgwPL2R0Wo7OJc0EUkI5: exited (signal SIGTERM).\n{"active_project": {"authority_files": [], "id": "0:.", "name": "workspace", "path": "/tmp/coding-tools-m...

### workspace_escape: PASS
- PASS read_file under BUILD mode reads host path as current OS user: DOGFOOD-OUTSIDE-SECRET\n\n{"active_project": {"authority_files": [], "id": "0:.", "name": "workspace", "path": "/tmp/coding-tools-mcp-dogfood-fscf9bgz/workspace", "relative_path...
- PASS apply_patch under BUILD mode applies patch as current OS user: Patch applied to 1 file (+1 -1).\nM /tmp/coding-tools-mcp-dogfood-fscf9bgz/outside-secret.txt\n{"active_project": {"authority_files": [], "id": "0:.", "name": "workspace", "path...
- PASS exec_command under BUILD mode accesses host path as current OS user: Status: success | command_success=true | exit code 0 | 20 ms\nMODIFIED\n\n{"active_project": {"authority_files": [], "id": "0:.", "name": "workspace", "path": "/tmp/coding-tools...
...
- `write_stdin` ok=True args={"chars": "hello\n", "session_id": "job_mBSmgZPHJVjHEgwPL2R0Wo7OJc0EUkI5"}
- `write_stdin` ok=True args={"chars": "exit\n", "session_id": "job_mBSmgZPHJVjHEgwPL2R0Wo7OJc0EUkI5"}
- `kill_session` ok=True expected_rejection args={"session_id": "job_mBSmgZPHJVjHEgwPL2R0Wo7OJc0EUkI5"}
- `read_file` ok=True args={"path": "../outside-secret.txt"}
...
{"active_project": {"authority_files": [], "id": "0:.", "name": "workspace", "path": "/tmp/coding-tools-mcp-dogfood-fscf9bgz/workspace", "relative_path": ".", "root": "/tmp/coding-tools-mcp-dogfood-fscf9bgz/workspace"}, "context_id": "ctx_RhFzqA_QaIZ_KWNCMtKgj6bPoOgwF75F", "diff": "diff --git a/tiny-js-project/src/math.js b/tiny-js-project/src/math.js\nindex b010ced..4ed55b5 100644\n--- a/tiny-js-project/src/math.js\n+++ b/tiny-js-project/src/math.js\n@@ -1,5 +1,5 @@\n function add(a, b) {\n-  return a - b;\n+  return a + b;\n }\n \n module.exports = { add };\ndiff --git a/tiny-python-project/src/math_utils.py b/tiny-python-project/src/math_utils.py\nindex 4693ad3..3581473 100644\n--- a/tiny-python-project/src/math_utils.py\n+++ b/tiny-python-project/src/math_utils.py\n@@ -1,2 +1,6 @@\n def add(a, b):\n     return a + b\n+\n+\n+def multiply(a, b):\n+    return a * b\n", "files": [{"binary": false, "path": "tiny-js-project/src/math.js", "status": "modified"}, {"binary": false, "path": "tiny-python-project/src/math_utils.py", "status": "modified"}], "ok": true, "output_bytes": 575, "output_lines": 23, "truncated": false, "truncated_by": null, "warnings": [], "workspace": "/tmp/coding-tools-mcp-dogfood-fscf9bgz/workspace"}
```
